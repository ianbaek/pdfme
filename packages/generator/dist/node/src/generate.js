...
const schemas_2 = require("@pdfme/schemas");
...
const generate = async (props) => {
    ...
    for (let i = 0; i < inputs.length; i += 1) {
        ...
        const dynamicTemplate = await (0, common_1.getDynamicTemplate)({
            ...
            getDynamicHeights: (value, args) => {
                switch (args.schema.type) {
                    ...
                    case 'multiTable':
                        return (0, schemas_2.getDynamicHeightsForMultiTable)(value, args);
                    default:
        ...
        const hasFillable = schemas.some((page) => page.some((schema) => schema.fillable));
        ...
        for (let j = 0; j < basePages.length; j += 1) {
            ...
            if ((0, common_1.isBlankPdf)(basePdf) && basePdf.staticSchema) {
                for (let k = 0; k < basePdf.staticSchema.length; k += 1) {
                    ...
                    const value = staticSchema.readOnly ? (0, common_1.replacePlaceholders)({
