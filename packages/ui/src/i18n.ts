...
const dictEn: { [key in keyof Dict]: string } = {
  ...
  'schemas.multiTable.tableGroupSpacing': 'Table Group Spacing',
...
const dictZh: { [key in keyof Dict]: string } = {
  ...
  'schemas.multiTable.tableGroupSpacing': '表格组间距',
...
const dictJa: { [key in keyof Dict]: string } = {
  ...
  'schemas.multiTable.tableGroupSpacing': 'テーブルグループ間隔',
...
const dictKo: { [key in keyof Dict]: string } = {
  ...
  'schemas.multiTable.tableGroupSpacing': '테이블 그룹 간격',
...
const dictAr: { [key in keyof Dict]: string } = {
  ...
  'schemas.multiTable.tableGroupSpacing': 'مسافة المجموعات الجدولية',
...
const dictTh: { [key in keyof Dict]: string } = {
  ...
  'schemas.multiTable.tableGroupSpacing': 'ระยะห่างกลุ่มตาราง',
...
const dictIt: { [key in keyof Dict]: string } = {
  ...
  'schemas.multiTable.tableGroupSpacing': 'Spaziatura tra gruppi di tabelle',
...
const dictPl: { [key in keyof Dict]: string } = {
  ...
  'schemas.multiTable.tableGroupSpacing': 'Spaziatura między grupami tabel',
...
const dictDe: { [key in keyof Dict]: string } = {
  ...
  'schemas.multiTable.tableGroupSpacing': 'Tabellengruppenabstand',
...
const dictEs: { [key in keyof Dict]: string } = {
  ...
  'schemas.multiTable.tableGroupSpacing': 'Espaciado entre grupos de tablas',
...
const dictFr: { [key in keyof Dict]: string } = {
  ...
  'schemas.multiTable.tableGroupSpacing': 'Espacement entre groupes de tables',
