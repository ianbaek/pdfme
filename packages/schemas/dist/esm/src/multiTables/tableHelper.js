...
function getTableOptions(schema, body, tableIndex = 0) {
    ...
    const columnStylesWidth = targetTable.headWidthPercentages.reduce((acc, cur, i) => ({ ...acc, [i]: { cellWidth: schema.width * (cur / 100) } }), {});
...
function parseInput(schema, body, tableIndex = 0) {
...
export function createSingleTable(body, args, tableIndex = 0) {
