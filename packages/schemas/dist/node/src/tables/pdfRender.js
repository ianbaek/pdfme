...
const pdfRender = async (arg) => {
    ...
    const body = (0, helper_js_1.getBodyWithRange)(typeof value !== 'string' ? (value ? JSON.stringify(value) : '[]') : value || '[]', schema.__bodyRange);
    ...
    const table = await (0, tableHelper_js_1.createSingleTable)(body, createTableArgs);
