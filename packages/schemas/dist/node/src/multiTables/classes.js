    ...
    getContentHeight() {
        ...
        if (typeof this.raw === 'object' && this.raw) {
            ...
            if (contentType === 'image') {
                ...
                const minHeight = (0, common_1.pt2mm)(this.styles.fontSize) * 4; // Reasonable default
                ...
                const minHeight = (0, common_1.pt2mm)(this.styles.fontSize) * 3; // Reasonable default
                return Math.max(minHeight + vPadding, this.styles.minCellHeight);
            }
            // Unknown content type
            const height = (0, common_1.pt2mm)(this.styles.fontSize) * this.styles.lineHeight + vPadding;
    ...
    for (const row of table.allRows()) {
        for (const column of table.columns) {
            ...
            if (typeof cell.raw === 'string') {
                ...
                if (contentType === 'image') {
                ...
                else if (contentType && constants_js_1.BARCODE_TYPES.includes(contentType)) {
                    ...
                    cell.text = ['[Barcode]'];
                    cell.contentHeight = Math.max(barcodeHeight, (0, common_1.pt2mm)(cell.styles.fontSize) * 2) + vPadding;
                }
                else {
                    cell.text = ['[Content]'];
                    cell.contentHeight = (0, common_1.pt2mm)(cell.styles.fontSize) * cell.styles.lineHeight + vPadding;
                }
            }
