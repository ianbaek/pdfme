...
function getExtraFormatterSchema(i18n, enableFillable) {
    const buttons = [
        {
            key: Formatter.STRIKETHROUGH,
            icon: index_js_1.TextStrikethroughIcon,
            type: 'boolean',
            disabled: enableFillable,
        },
        {
            key: Formatter.UNDERLINE,
            icon: index_js_1.TextUnderlineIcon,
            type: 'boolean',
            disabled: enableFillable,
        },
        ...
        { key: Formatter.ALIGNMENT, icon: index_js_1.TextAlignRightIcon, type: 'select', value: constants_js_1.ALIGN_RIGHT },
        {
            ...
            icon: index_js_1.TextAlignJustifyIcon,
            type: 'select',
            value: constants_js_1.ALIGN_JUSTIFY,
            disabled: enableFillable,
        },
        {
