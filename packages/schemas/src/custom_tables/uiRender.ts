...
import type { CustomTableSchema, CellStyle, Styles } from './types.js';
...
const setBorder = (
  ...
  arg: UIRenderProps<CustomTableSchema>,
) => {
...
export const uiRender = async (arg: UIRenderProps<CustomTableSchema>) => {
